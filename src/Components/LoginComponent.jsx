      ...
      <div className="login-section">
        <div className="login-form-section">
          <div className="login-form">
            ...
            <div id="fp-container">
              <Link id="login-form-fp" to={"/register"}>
                Forgot password?
              </Link>
            </div>

            <div className="signin-btn-container">
              <button id="loginBtn" onClick={signInWithEmail}>
                Sign in
              </button>
            </div>
          </div>
          ...
          <div className="login-widget">
            <img id="widget-image" src="/person-browsing-items-online.png" />
          </div>
        </div>
      </div>
    </>
