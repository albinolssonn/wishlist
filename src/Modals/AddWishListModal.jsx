    ...
    <div className='wlModalBG' style={{width:"80%",margin:"auto",marginBottom:"10px",background:"#ffffff",borderRadius:"5px",position:"relative"}}>
        <div className="wlModalContainer" style={{maxWidth:"50%",margin:"auto",padding:"10px",position:"relative"}}>
            ...
            <div className="wlColorForm">
                ...
                <div className="wlColorGrid" style={{margin:"20px 0px",display:"grid",textAlign:"center",gridTemplateColumns:"repeat(auto-fit, minmax(30px, 1fr))"}}>
                    <div className="colorRadioBtn" id={colorBtn1} onClick={()=> setNewColor("ff6e6e") & setButtonColorActive(1)} style={{width:"20px",height:"20px",background:"#ff6e6e",margin:"auto",borderRadius:"3px"}}></div>
                    <div className="colorRadioBtn" id={colorBtn2} onClick={()=> setNewColor("ffce6e") & setButtonColorActive(2)} style={{width:"20px",height:"20px",background:"#ffce6e",margin:"auto",borderRadius:"3px"}}></div>
                    <div className="colorRadioBtn" id={colorBtn3} onClick={()=> setNewColor("afff6e") & setButtonColorActive(3)} style={{width:"20px",height:"20px",background:"#afff6e",margin:"auto",borderRadius:"3px"}}></div>
                    <div className="colorRadioBtn" id={colorBtn4} onClick={()=> setNewColor("b6fbfa") & setButtonColorActive(4)} style={{width:"20px",height:"20px",background:"#b6fbfa",margin:"auto",borderRadius:"3px"}}></div>
                    <div className="colorRadioBtn" id={colorBtn5} onClick={()=> setNewColor("b492ff") & setButtonColorActive(5)} style={{width:"20px",height:"20px",background:"#b492ff",margin:"auto",borderRadius:"3px"}}></div>
                    <div className="colorRadioBtn" id={colorBtn6} onClick={()=> setNewColor("ff92e6") & setButtonColorActive(6)} style={{width:"20px",height:"20px",background:"#ff92e6",margin:"auto",borderRadius:"3px"}}></div>
                </div>
