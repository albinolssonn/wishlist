    ...
    <div className='wl-delete-modal'>
        <div className="wl-delete-modal-container">
            ...
            <div className="wl-delete-modal-buttons">
                ...
                <div className="wl-delete-modal-buttons-keep-btn" onClick={()=>deleteVerification(false)}>
                    <p>Behåll</p>
                    <CloseIcon />
                </div>
                    
                <div className="wl-delete-modal-buttons-remove-btn" onClick={()=>removeWishlist()}>
                    <p>Ta bort</p>
                    <DeleteIcon />
                </div>
